...
/*  Headings color  */
h1, h2, h3, h4, h5, h6, .welcome, .box-category-home > div.span2 a, .box-category-home > div.span3 a, .product-info .description span.stock {color: <?php echo $this->config->get('sellya_headings_color'); ?>;}

/*  Body text color  */
body, label, .dropdown_l li a, .box .box-content .box-content-information a, .box-product .name a, .box-product .l_column .name a, .box-category > ul > li > a, .box-category > ul > li a.active, .box-category > ul > li ul > li > a, .box-category-home > div.span2 > div > ul > li > a, .box-category-home > div.span3 > div > ul > li > a, .box-manufacturers-home > div.span2 > div > ul > li > a, .box-manufacturers-home > div.span3 > div > ul > li > a, .product-list .name a, .product-grid .name a, .product-grid .description, .product-name h1, .product-info .description a, .product-info .wishlist-compare a, .product-info .review a, .product-info a, .product-related .name a, .htabs a, .tags a, .es-carousel .name a {color: <?php echo $this->config->get('sellya_body_text_color'); ?>;}
.breadcrumb a, .category-list a, table.form > * > * > td {color: <?php echo $this->config->get('sellya_body_text_color'); ?>!important;}

/*  Light text color  */
#t-header #search input, .pagination .results, .help, .box-category-home > div.span2 > div.all a, .box-category-home > div.span3 > div.all a, .product-grid .wishlist a, .product-grid .compare a, .product-list .wishlist a, .product-list .compare a, .product-list .description, .product-info .description span, .product-info .cart, .product-info .cart div > span, .product-info .cart .minimum, #content .content .reviews-left span, .breadcrumb, .product-info .review {color: <?php echo $this->config->get('sellya_light_text_color'); ?>;}
...
.box .box-heading h2{color: <?php echo $this->config->get('sellya_left_right_column_head_title_color'); ?>;}
...
<?php if($this->config->get('sellya_custom_box_status')== 1) { ?>  
<?php if($this->config->get('sellya_custom_box_content') != '') { ?>
<div class="custom_box_<?php echo $this->config->get('sellya_custom_box_position'); ?> hidden-phone">
<div id="custom_box_icon"></div>
<div class="custom_box">
<?php echo htmlspecialchars_decode($this->config->get('sellya_custom_box_content')); ?> 
  <script type="text/javascript">    
  $(function(){        
...
<?php if($this->config->get('sellya_menu_link_1_url') != ''): ?>
    <div class="menu_links">
        ...
        <span><?php echo $this->config->get('sellya_menu_link_1'); ?></span>
		<?php } ?>
        </a>
    </div>
<?php endif; ?>
...
<?php if($this->config->get('sellya_menu_link_2_url') != ''): ?>
    <div class="menu_links">
        ...
        <span><?php echo $this->config->get('sellya_menu_link_2'); ?></span>
		<?php } ?>
        </a>
    </div>
<?php endif; ?>
...
<?php if($this->config->get('sellya_menu_link_3_url') != ''): ?>
    <div class="menu_links">
        ...
        <span><?php echo $this->config->get('sellya_menu_link_3'); ?></span>
		<?php } ?>
        </a>
    </div>
<?php endif; ?>
...
<?php if($this->config->get('sellya_menu_link_4_url') != ''): ?>
    <div class="menu_links">
        ...
        <span><?php echo $this->config->get('sellya_menu_link_4'); ?></span>
		<?php } ?>
        </a>
    </div>
<?php endif; ?>
...
<?php if($this->config->get('sellya_menu_link_5_url') != ''): ?>
    <div class="menu_links">
        ...
        <span><?php echo $this->config->get('sellya_menu_link_5'); ?></span>
		<?php } ?>
        </a>
    </div>
<?php endif; ?>
...
<?php if($this->config->get('sellya_menu_link_6_url') != ''): ?>
    <div class="menu_links">
        ...
        <span><?php echo $this->config->get('sellya_menu_link_6'); ?></span>
		<?php } ?>
        </a>
    </div>
<?php endif; ?>
...
<?php if($this->config->get('sellya_menu_link_7_url') != ''): ?>
    <div class="menu_links">
        ...
        <span><?php echo $this->config->get('sellya_menu_link_7'); ?></span>
		<?php } ?>
        </a>
    </div>
<?php endif; ?>
...
<?php if($this->config->get('sellya_menu_link_8_url') != ''): ?>
    <div class="menu_links">
        ...
        <span><?php echo $this->config->get('sellya_menu_link_8'); ?></span>
		<?php } ?>
        </a>
    </div>
<?php endif; ?>
...
<?php if($this->config->get('sellya_menu_link_9_url') != ''): ?>
    <div class="menu_links">
        ...
        <span><?php echo $this->config->get('sellya_menu_link_9'); ?></span>
		<?php } ?>
        </a>
    </div>
<?php endif; ?>
...
<?php if($this->config->get('sellya_menu_link_10_url') != ''): ?>
    <div class="menu_links">
        ...
        <span><?php echo $this->config->get('sellya_menu_link_10'); ?></span>
		<?php } ?>
        </a>
    </div>
<?php endif; ?>
...
<div id="menu_custom_block">        
  <ul>
    <li><a><?php echo $this->config->get('sellya_menu_custom_block_title'); ?></a> 
      <div>  
        <ul>
          <li> 
          <div>
...
<div id="menu_custom_block">        
  <ul>
    <li><a><?php echo $this->config->get('sellya_menu_custom_block_2_title'); ?></a> 
      <div>  
        <ul>
          <li> 
          <div>
...
<div id="menu_custom_block">        
  <ul>
    <li><a><?php echo $this->config->get('sellya_menu_custom_block_3_title'); ?></a> 
      <div>  
        <ul>
          <li> 
          <div>
  ...
  <ul>
    <li><a href="<?php echo $contact; ?>"><?php echo $text_menu_contact_us; ?></a> 
     ...
     <div class="span3">
        ...
        <span><pre><?php echo $this->config->get('sellya_contact_hours'); ?></pre></span><br /> 
		<?php } ?><br />  	    
        <a href="<?php echo $contact; ?>" class="button" style="margin-bottom:20px"><?php echo $text_menu_contact_form; ?></a> 
     </div>
          </li>
